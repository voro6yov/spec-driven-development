...
Invoke `@spec-core:project-package-finder` with prompt `/messaging-spec:init-messaging`. Wait for completion. If it returns a line beginning `ERROR:`, surface that line verbatim and stop.
