...
- It does not chain into domain `/update-specs` — it is independently invocable; the opt-in chained-step integration (Step 10 of domain `/update-specs`) is a separate, later change.
